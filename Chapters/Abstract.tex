...
In this thesis tight-binding parameters for \emph{trans}-polyacetylene are calculated with density functional theory, which are mainly in good accordance with known literature values. 
\\
