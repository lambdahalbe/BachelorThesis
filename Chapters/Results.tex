...
\begin{figure}
	\centering
	\includegraphics[width = 13cm]{Images/polyacetylene/wavefunctions/Homo}
	\caption{Isosurface for the HOMO-band state at the edge of the \textsc{Brillouin} zone.}
	\label{image_homo1}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width = 13cm]{Images/polyacetylene/wavefunctions/LUMO}
	\caption{Isosurface for the LUMO-band state at the edge of the \textsc{Brillouin} zone.}
	\label{image_lumo1}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width = 13cm]{Images/polyacetylene/wavefunctions/HOMO_Side_View}
...
\begin{figure}
	\centering
	\includegraphics[width = 13cm]{Images/polyacetylene/bands/band_structure}
...
\begin{figure}
	\centering
	\includegraphics[width = 13cm]{Images/polyacetylene/wavefunctions/Homo_mid_k}
	\caption{Isosurface for the HOMO-band state at the $\Gamma$-point.}
	\label{image_homo_mid_k}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width = 13cm]{Images/polyacetylene/wavefunctions/Homo_mid_k_Side_View}
...
\begin{figure}
	\centering
	\includegraphics[width = 13cm]{Images/polyacetylene/wavefunctions/Mid_band_2}
	\caption{Isosurface of the third band at the $\Gamma$-point.}
	\label{image_third_band}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width = 13cm]{Images/polyacetylene/wavefunctions/Mid_band_2_Side_View}
...
\begin{figure}
	\centering
	\includegraphics[width = 13cm]{Images/polyacetylene/bands/bandstructure_manually_displaced}
