...
\begin{align}
	\left\langle\Psi_k^{(v)}\Big|\mathcal{H}_{\text{hopp}}\Big|\Psi_k^{(v)}\right\rangle &= \sqrt{\frac{1}{2}-q}c_k^{\dagger(e)}- \sqrt{\frac{1}{2}+q}\frac{\epsilon_k - i \Delta_k}{|E_k|}c_{k}^{\dagger(o)}
\end{align}
